...
ARXIV_QUERY = '"large language model" OR "LLM" OR "transformer" OR "natural language processing" OR "NLP" OR "artificial intelligence" OR "AI" OR "reinforcement learning"'
MAX_RESULTS = 20
